        ...
        layers: [
            {
                ...
                options: {
                    layers: "RiskZone",              // layer name from INSPIRE metadata
                    format: "image/png",
                    transparent: true,
        ...
        layers: [
            {
                ...
                type: "wms",
                // current PDOK INSPIRE WMS
                url: "https://service.pdok.nl/rvo/beschermdegebieden/natura2000/wms/v1_0?",
                options: {
                    // layer name commonly used for this service
                    layers: "natura2000",
                    // optional style: "natura2000:lnv_natura2000"
                    format: "image/png",
                    transparent: true,
